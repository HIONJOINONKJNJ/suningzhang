...
//禁止复制结束
// 搜索开始
let headInput=document.querySelector(".head-con .search .top .left input");
let headSpan=document.querySelector(".head-con .search .top .left span");
console.log(headInput,headSpan);
headInput.onfocus=function(){
	console.log(1);
...
//抢购开始
let hours=document.querySelector(".rush_to_buy .time-buy .title .del-time .hours");
let minutes=document.querySelector(".rush_to_buy .time-buy .title .del-time .minutes");
let seconds=document.querySelector(".rush_to_buy .time-buy .title .del-time .seconds");
let timeBuy=setInterval(function(){
	...
	minutes.innerHTML=fillZero(minutes.innerHTML);
	seconds.innerHTML=fillZero(seconds.innerHTML);
},1000)
